...
import javax.safetycritical.annotate.Pure;
...
public class Services
{
  ...
  /**
   *@return an AffinitySet representing the scheduling domain defined by the bitSet
   *@throws ProcessorAffinityException if a processor indicated by the bitSet already appears
   *        in a previously created scheduling domain
   */
  @SCJAllowed
  public static AffinitySet createSchedulingDomain (java.util.BitSet bitSet) { return null;};
   ...
   */
  @SCJAllowed(LEVEL_1)
  public static int getDefaultCeiling() { return 30; }
   ...
   * determined by the StorageConfigurationParameters object that
