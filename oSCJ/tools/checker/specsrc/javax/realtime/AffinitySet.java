...
public final class AffinitySet extends java.lang.Object {
  ...
  @SCJAllowed(LEVEL_1)
  public static final AffinitySet getAffinitySet(BoundAsyncEventHandler handler) {return null;};
  
  @SCJAllowed(LEVEL_2)
  public static final AffinitySet getAffinitySet(java.lang.Thread thread) {return null;};
  
  @SCJAllowed(LEVEL_1)
  public static final java.util.BitSet getAvailableProcessors() {return null;};
  
  @SCJAllowed(LEVEL_1)
  public static final java.util.BitSet getAvailableProcessors(java.util.BitSet dest) {return null;};
  
  @SCJAllowed(LEVEL_1)
  public final java.util.BitSet getBitSet() {return null;};
  ...
  @SCJAllowed(LEVEL_1)
  public static AffinitySet[] getPredefinedAffinitySets(AffinitySet[] dest) {return null;};
  
  @SCJAllowed(LEVEL_2)
  public final java.util.BitSet getProcessors(java.util.BitSet dest) {return null;};

  @SCJAllowed(LEVEL_2)
  public final boolean isProcessorInSet(int processorNumber) {return true;};
