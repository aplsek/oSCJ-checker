...
public class AbsoluteTime extends HighResolutionTime {
	 ...
	 * @param ms The desired value for the millisecond component of this. The actual value is the result of parameter normalization.
	 * @param ns The desired value for the nanosecond component of this. The actual value is the result of parameter normalization.
	 */
	@BlockFree
	@SCJAllowed
...
//	 */
	 ...
	 * @param ms The desired value for the millisecond component of this. The actual value is the result of parameter normalization.
	 * @param ns The desired value for the nanosecond component of this. The actual value is the result of parameter normalization.
	 * @param clock The clock providing the association for the newly constructed object.
	 */
	@BlockFree
	@SCJAllowed
	 ...
	 * @return A new AbsoluteTime object whose time is the normalization of this plus millis and nanos. 
	 */
	@Allocate( { CURRENT })
	@BlockFree
	@SCJAllowed
	 ...
	 * @param millis The number of milliseconds to be added to this.
	 * @param nanos The number of nanoseconds to be added to this. 
	 * @param dest If dest is not null, the result is placed there and returned. Otherwise, a new object is allocated for the result. 
	 * @return the result of the normalization of this plus millis and nanos in dest if dest is not null, otherwise the result is returned in a newly allocated object. 
	 */
	@BlockFree
	@SCJAllowed
	 ...
	 * @return A new AbsoluteTime object whose time is the normalization of this plus the parameter time.
	 */
	@Allocate( { CURRENT })
	@BlockFree
	@SCJAllowed
	 ...
	 * @param time The time to add to this.
	 * @param dest If dest is not null, the result is placed there and returned. Otherwise, a new object is allocated for the result. 
	 * @return the result of the normalization of this plus the RelativeTime  parameter time in dest if dest is not null, otherwise the result is returned in a newly allocated object.
	 */
	@BlockFree
	@SCJAllowed
	 ...
	 * @return A new RelativeTime object whose time is the normalization of this minus the AbsoluteTime  parameter time.
	 */
	@Allocate( { CURRENT })
	@BlockFree
	@SCJAllowed
	 ...
	 * @param time The time to subtract from this.
	 * @param dest If dest is not null, the result is placed there and returned. Otherwise, a new object is allocated for the result.
	 * @return the result of the normalization of this minus the AbsoluteTime  parameter time in dest if dest is not null, otherwise the result is returned in a newly allocated object. 
	 */
	@BlockFree
	@SCJAllowed
	 ...
	 * @param time The time to subtract from this. 
	 * @return A new AbsoluteTime object whose time is the normalization of this minus the parameter time. 
	 */
	@Allocate( { CURRENT })
	@BlockFree
	@SCJAllowed
	 ...
	 * @param time The time to subtract from this.
	 * @param dest If dest is not null, the result is placed there and returned. Otherwise, a new object is allocated for the result.
	 * @return the result of the normalization of this minus the RelativeTime  parameter time in dest if dest is not null, otherwise the result is returned in a newly allocated object. 
	 */
	@BlockFree
	@SCJAllowed
