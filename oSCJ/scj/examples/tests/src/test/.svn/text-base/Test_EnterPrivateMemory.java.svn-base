...
public class Test_EnterPrivateMemory extends CyclicExecutive {

    public Test_EnterPrivateMemory() {
        super(null);
    }
    ...
    public static void main(final String[] args) {
        ...
        Safelet safelet = new Test_EnterPrivateMemory();
        safelet.setUp();
...
class MyRunnable implements Runnable {
	...
	public void run() {
		System.out.println(">>>>>> EnterPrivate MEMORY OK.  In HelloWorld runnable!! YES!!!!!");
		Utils.debugPrint(">>>>>> Memory:"
