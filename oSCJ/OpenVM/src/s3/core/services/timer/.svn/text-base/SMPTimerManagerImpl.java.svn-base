...
public class SMPTimerManagerImpl extends BaseTimerManagerImpl {

    private static final class Helper implements NativeInterface {
        static native int initSMPTimer(long period);
    }
     ...
     */
    protected static TimerManager instance = new SMPTimerManagerImpl();
     ...
     *
     */
    public SMPTimerManagerImpl(int size) {
	super(size);
    }
