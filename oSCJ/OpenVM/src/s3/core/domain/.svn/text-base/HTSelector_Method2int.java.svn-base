// HashtableName : HTSelector_Method2int
 ...
 * @author TGen2
 **/
public class HTSelector_Method2int extends ovm.core.OVMBase {
    ...
    Selector.Method[] keys_; // array of keys
    int[] values_; // array of values

    public static final HTSelector_Method2int EMPTY =
        new HTSelector_Method2int(0) {
        /**
         * Put a key and value into the hashtable. Checks to see if
         * the key is already in the hashtable, and if so, updates
         * the value associated with the key.
         **/
        public void put(Selector.Method key, int value) {
            throw new Error("can not put into empty Selector.Method");
        }
    ...
    static private final class Binding extends ovm.core.OVMBase {
        ...
        Selector.Method key;
        int value;
        Binding(Binding link, Selector.Method key, int value) {
            this.link = link;
            this.key = key;
            this.value = value;
        }
     ...
     **/
    public HTSelector_Method2int() {
        this(DEFAULT_SIZE);
    }

    protected HTSelector_Method2int(HTSelector_Method2int other) {
     ...
     **/
    public HTSelector_Method2int(int hint) {
        int size = 8;
        int sizeCollisions;
        while (size < hint)
            size *= 2;
     ...
     **/
    public final int get(Selector.Method key) {
     ...
     **/
    private final int findInCollisions(int offset, Selector.Method key) {
        Binding p;
    ...
    public void remove(Selector.Method key) {
        int hash = mask_ & key.hashCode();
        Selector.Method result = keys_[hash];
        if (result == null)
            return;
