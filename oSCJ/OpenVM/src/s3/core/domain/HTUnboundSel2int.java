...
// HashtableName : HTRepositoryUnboundSelector_Method2int
 ...
 * @author TGen2
 **/
public class HTUnboundSel2int extends ovm.core.OVMBase {



    public static final int MININT = Integer.MIN_VALUE;
    public static final int NOTFOUND = -1; 
    public static final HTUnboundSel2int EMPTY 
        = new HTUnboundSel2int(0) {
        /**
         * Put a key and value into the hashtable. Checks to see if
         * the key is already in the hashtable, and if so, updates
         * the value associated with the key.
         **/
         public void put(UnboundSelector.Method key, int value) {
              throw new Error("can not put into empty RepositoryUnboundSelector.Method");
         }
    ...
    public HTUnboundSel2int cloneHT() {
         HTUnboundSel2int clone = new HTUnboundSel2int(this);
	...
	int value;
	Binding(Binding link, UnboundSelector.Method key, int value) {
	    this.link = link;
	    this.key = key;
	    this.value = value;
	} 
    ...
    protected HTUnboundSel2int complementaryView_;

    public  HTUnboundSel2int getReadOnlyView() {
    ...
    private static class ReadOnly extends HTUnboundSel2int {
	ReadOnly(HTUnboundSel2int other) {	
		super(other);
     ...
     **/
    public HTUnboundSel2int() {
	this(DEFAULT_SIZE);
    }

    protected HTUnboundSel2int(HTUnboundSel2int other) {
     ...
     **/
    public HTUnboundSel2int(int hint) {	    
        int size = 8;
	int sizeCollisions;
     ...
     **/
    public final int get(UnboundSelector.Method key) {
     ...
     **/
    private final int findInCollisions(int offset, UnboundSelector.Method key) {
	Binding p;
...
} // End HTRepositoryUnboundSelector_Method2int
