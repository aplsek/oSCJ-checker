// $Header: /p/sss/cvs/OpenVM/src/s3/core/stitcher/SIGIOSockets_PollingOther_IOServiceConfigurator.java,v 1.3 2004/03/08 18:57:27 pizlofj Exp $
 ...
 * @author Filip Pizlo
 */
public class SIGIOSockets_PollingOther_IOServiceConfigurator
    ...
    protected class AsyncIOServicesFactory
        ...
        public String toString() {
            return super.toString() +
                " with SIGIO for sockets and Polling for everything else";
        }
    }
    ...
    protected void initFactories() {
        ...
        if (factories.get(AsyncIOServicesFactory.name) == null)
            factories.put(AsyncIOServicesFactory.name,
                new SIGIOSockets_PollingOther_IOServiceConfigurator.AsyncIOServicesFactory());
