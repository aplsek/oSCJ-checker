...
import s3.services.io.async.StallingFileDescriptor;
 ...
 * @author Filip Pizlo
 */
public class SelectSockets_StallingFiles_PollingOther_IOServiceConfigurator
    ...
    protected void initFactories() {
        ...
        if (factories.get(AsyncIOServicesFactory.name) == null)
            factories.put(AsyncIOServicesFactory.name,
                new SelectSockets_StallingFiles_PollingOther_IOServiceConfigurator.AsyncIOServicesFactory());
