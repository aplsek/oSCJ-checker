...
// HashtableName : HTObject2Monitor
// KeyType       : Object
// ValueType     : Monitor
// Compare       : ==
 ...
 * value type is Monitor.
 * @author Ben L. Titzer
 * @author Christian Grothoff
 * @author TGen2
 **/
public class HTObject2Monitor extends ovm.core.OVMBase {



    public static final int MININT = Integer.MIN_VALUE;
    public static final Monitor NOTFOUND = null; 
    public static final HTObject2Monitor EMPTY 
        = new HTObject2Monitor(0) {
        /**
         * Put a key and value into the hashtable. Checks to see if
         * the key is already in the hashtable, and if so, updates
         * the value associated with the key.
         **/
         public void put(Object key, Monitor value) {
    ...
    private Object[] keys_;     // array of keys
    private Monitor[] values_; // array of values
    ...
    public HTObject2Monitor cloneHT() {
         HTObject2Monitor clone = new HTObject2Monitor(this);
         keys_ = (Object[]) keys_.clone();
         values_ = (Monitor[]) values_.clone();
	...
	Object key;
	Monitor value;
	Binding(Binding link, Object key, Monitor value) {
	    this.link = link;
	    this.key = key;
	    this.value = value;
	} 
    ...
    protected HTObject2Monitor complementaryView_;

    public  HTObject2Monitor getReadOnlyView() {
    ...
    private static class ReadOnly extends HTObject2Monitor {
	ReadOnly(HTObject2Monitor other) {	
		super(other);
     ...
     **/
    public HTObject2Monitor() {
	this(DEFAULT_SIZE);
    }

    protected HTObject2Monitor(HTObject2Monitor other) {
     ...
     **/
    public HTObject2Monitor(int hint) {	    
        int size = 8;
	int sizeCollisions;
     ...
     **/
    public final Monitor get(Object key) {
     ...
     **/
    private final Monitor findInCollisions(int offset, Object key) {
	Binding p;
