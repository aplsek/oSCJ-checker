 ...
 */
 ...
 // this differs from PragmaAtomic in that there is no "yield" at the end 
 //  -- it calls setReschedulingEnabledNoYield instead of setReschedulingEnabled
 
public class PragmaAtomicNoYield extends PragmaAtomic {
    
    private static final TypeName.Scalar me=
        register( "s3.util.PragmaAtomicNoYield",
                  "cookie");
