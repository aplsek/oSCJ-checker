...
public class TestMethods extends TestBase {
	...
	IFace1 i1 = c;
	int testval = 5;
	check_condition(42 == i1.imethod2(testval));
	IFace2 i2 = c;
	check_condition(42 == i2.imethod4(testval));
	IFace3 i3 = c;
	check_condition(testval == i3.imethod5(testval));

	check_condition(42 == i3.imethod6());

    }

    void testStaticMethods() {
	check_condition(2 == Class1.smethodA(1, 2, 3));
	check_condition(2 == Class2.smethodB(1, 2, 3, 4));
	check_condition(3 == Class2.smethodA(1, 2));
	check_condition(0 == Class1.smethodC(1, 2));
    }
	...
	static int smethodA(int arg, int dummy1, int dummy2) {
	    me.check_condition( int1 - int2 == 2);
	    return arg + 1;
	}
