...
public class TestLinpack extends TestBase {
  ...
  {
    if (second_orig==-1) {
      second_orig =  Native.getCurrentTime();
    }
    return ( (double) (Native.getCurrentTime() - second_orig))/ (double)TimeConversion.NANOS_PER_SECOND;
  }
