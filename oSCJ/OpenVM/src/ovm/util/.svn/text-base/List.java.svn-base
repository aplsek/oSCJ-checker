...
/**
 * A list implementation of Collection. Represents an ordered collection
 * of objects and conforms to the Java API for the List interface.
 *
...
public interface List extends Collection
{
   ...
   * @return true, as Collection defines this method as returning true if the
   ...
   * @return true if this list contains an element e such that <code>o ==
