 ...
 * @author Ben L. Titzer
 */
public class Collections extends OVMBase {
    /**
     ...
     * spec.
     */
    public static final Set EMPTY_SET = new EmptyAbstractSet();

    static class EmptyAbstractSet extends AbstractSet {
        public int size() {
            return 0;
        }
    ...
    private static class UnmodifiableCollection
        ...
        public boolean addAll(Collection _) {
            throw new UnsupportedOperationException();
        }
        public void clear() {
            throw new UnsupportedOperationException();
        ...
        public boolean retainAll(Collection _) {
            throw new UnsupportedOperationException();
        }
        public int size() {
            return c.size();
    ...
    private static class UnmodifiableList
        ...
        public boolean addAll(int index, Collection _) {
            throw new UnsupportedOperationException();
        }
    ...
    private static class SynchronizedListIterator
    ...
    private static class SynchronizedCollection
        implements Collection, Serializable {
        Object sync;
        Collection c;
