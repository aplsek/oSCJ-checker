 ...
 * @modified $Id: HashMap.java,v 1.5 2003/12/24 01:54:42 jv Exp $ */
        ...
        if (size > 0) {
            ...
            if (list != null) {
                ...
                if (result != Bucket.NO_ENTRY) {
                    size--;
                    modCount++;
                    if (list.first == null) buckets[index] = null;
                }
            }
        }
...
*/
   ...
   * @modified     $Id: HashMap.java,v 1.5 2003/12/24 01:54:42 jv Exp $
   */
    class HashMapIterator extends OVMBase implements Iterator 
    {
...
//            checkMod();
            ...
            try
                {
                    ...
                    result = (myType == KEYS_) ? currentKey :
                        ((myType == VALUES_) ? currentNode.getValue() : currentNode);
   ...
   * @modified   $Id: HashMap.java,v 1.5 2003/12/24 01:54:42 jv Exp $
   */
    private static class Null extends OVMBase {
        Null() { }
    } // End of Null
