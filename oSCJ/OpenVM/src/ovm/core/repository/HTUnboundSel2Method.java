...
// HashtableName : HTUnboundSel2Method
// KeyType       : UnboundSelector.Method
// ValueType     : RepositoryMember.Method
// Compare       : .equals
...
// Synchronized  : no
// Serializable  : no
// Iterator      : ovm.core.repository.RepositoryMember.Method.Iterator
// Profiling     : no 

package ovm.core.repository;
/**
 * This Hashtable is generated by TGen. Its key type is UnboundSelector.Method and its
 * value type is RepositoryMember.Method.
 * @author Ben L. Titzer
 * @author Christian Grothoff
 * @author TGen2
 **/
public class HTUnboundSel2Method extends ovm.core.OVMBase {

    public static final int MININT = Integer.MIN_VALUE;
    public static final RepositoryMember.Method NOTFOUND = null; 
    ...
    private int numElems_;                 // tracks the size of the hashtable
     UnboundSelector.Method[] keys_;     // array of keys
     RepositoryMember.Method[] values_; // array of values
    ...
    public HTUnboundSel2Method cloneHT() {
         HTUnboundSel2Method clone = new HTUnboundSel2Method(this);
         keys_ = (UnboundSelector.Method[]) keys_.clone();
         values_ = (RepositoryMember.Method[]) values_.clone();
	...
	Binding link;
	UnboundSelector.Method key;
	RepositoryMember.Method value;
	Binding(Binding link, UnboundSelector.Method key, RepositoryMember.Method value) {
	    this.link = link;
	    this.key = key;
	    this.value = value;
	} 
    ...
    protected HTUnboundSel2Method complementaryView_;

    public  HTUnboundSel2Method getReadOnlyView() {
    ...
    private static class ReadOnly extends HTUnboundSel2Method {
	ReadOnly(HTUnboundSel2Method other) {	
		super(other);
	...
	public HTUnboundSel2Method getReadOnlyView() {
 	...
 	public void put(UnboundSelector.Method key, RepositoryMember.Method value) {
		throw new ovm.util.ReadonlyViewException();
	}
 	public int size() {
        	return complementaryView_.size();
    	}
    	public void remove(UnboundSelector.Method key) {
		throw new ovm.util.ReadonlyViewException();
	}
    }
     ...
     **/
    public HTUnboundSel2Method() {
	this(DEFAULT_SIZE);
    }

    protected HTUnboundSel2Method(HTUnboundSel2Method other) {
     ...
     **/
    public HTUnboundSel2Method(int hint) {	    
        int size = 8;
	int sizeCollisions;
	...
	this.keys_ = new UnboundSelector.Method[size];
	this.values_ = new RepositoryMember.Method[size];
     ...
     **/
    public final RepositoryMember.Method get(UnboundSelector.Method key) {
	int hash = mask_&key.hashCode();
	UnboundSelector.Method keys_hash = keys_[hash];
	if (keys_hash == null) {
     ...
     **/
    private final RepositoryMember.Method findInCollisions(int offset, UnboundSelector.Method key) {
	Binding p;
    ...
    public void  remove(UnboundSelector.Method key) {
	int hash = mask_ & key.hashCode();
	UnboundSelector.Method result = keys_[hash];
    ...
    public final class Iterator implements ovm.core.repository.UnboundSelector.Method.Iterator {
	...
	public RepositoryMember.Method nextValue() {
	    RepositoryMember.Method res;
	    if (iteratingOverKeys_) {
