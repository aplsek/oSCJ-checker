# SCJ package Makefile
#
# Build the safety-critical runtime classes. Some classes here will "override" those
...
JAVA_JARFILE=ovm_rt_user_scj.jar

JAVA_EXCLUDES=

# TODO: change this to javax.safetycritical?
...
$(JAVA_JARFILE): java-compile
	(echo META-INF/MANIFEST.MF;				    \
		...
		| sed 's,^./,,' | zip -q@ ovm_rt_user_scj.zip
	mv ovm_rt_user_scj.zip $@
