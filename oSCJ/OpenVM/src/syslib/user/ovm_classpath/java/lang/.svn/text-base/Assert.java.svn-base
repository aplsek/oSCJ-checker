/*
 * $Header: /p/sss/cvs/OpenVM/src/syslib/user/ovm_classpath/java/lang/Assert.java,v 1.5 2005/07/15 02:33:14 dholmes Exp $
 */
package java.lang;
...
class Assert {
    ...
    static final String OK = "java.lang.Assert.OK";
