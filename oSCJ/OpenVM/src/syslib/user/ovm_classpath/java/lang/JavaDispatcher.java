/* 
 *
 * $Header: /p/sss/cvs/OpenVM/src/syslib/user/ovm_classpath/java/lang/JavaDispatcher.java,v 1.12 2007/05/18 17:42:41 baker29 Exp $
 *
 */
package java.lang;
...
class JavaDispatcher {
    ...
    void bindVMThread(VMThreadBase t) {
        ...
        Opaque newVMThread = LibraryImports.createVMThread(t);
    ...
    void startThread(VMThreadBase t) {     
        // assert: t.vmThread != null   
    	Utils.debugPrint("[OVM] Java Dispatcher.startThread...");
        LibraryImports.startThread(t.vmThread);
        Utils.debugPrint("[OVM] Java Dispatcher.startThread... OK");
    }
