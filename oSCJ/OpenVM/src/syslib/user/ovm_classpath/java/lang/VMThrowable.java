...
final class VMThrowable {
    ...
    private Opaque code;	// ovm.core.domain.Code[]
    private Opaque pc;		// Executive domain int[]

    /**
     * Fill in the stack trace with the current execution stack.
     * Called by <code>Throwable.fillInStackTrace()</code> to get the state of
     * the VM. Can return null when the VM does not support computing the VM
     * execution state.
     *
	...
	VMThrowable ret = new VMThrowable();
	LibraryImports.fillInStackTrace(ret);
	return ret;
    }
	...
	return LibraryImports.getStackTrace(this);
    }
}
