...
SCJFLAGS="--scj --scj-scope-backing 13500k --g-def-immortal-mem 12330k --pollcheck-mode none"   #700 scope, 500 imm
...
# COMPILE FIJI
$FIJI_HOME/bin/fivmc -o papabench-scope --scj-safelet $SAFELET $FIJIFLAGS $SCJFLAGS papabench.jar
	
	
# RUN:	
./papabench-scope | tee papabench-scope.cap
