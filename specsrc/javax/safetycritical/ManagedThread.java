...
@SCJAllowed(LEVEL_2)
public class ManagedThread extends javax.realtime.RealtimeThread
{
  /**
  ...
  @SCJAllowed(LEVEL_2)
  public ManagedThread(PriorityParameters scheduling,
  ...
  @SCJAllowed(LEVEL_2)
  public boolean terminationPending() { return true;};
}
