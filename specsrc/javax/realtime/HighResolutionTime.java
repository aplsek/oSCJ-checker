...
public abstract class HighResolutionTime implements Comparable {
	 ...
	 * @param millis This value shall be the value of the millisecond component of this at the completion of the call.
	 */
	@BlockFree
	@SCJAllowed
	 ...
	 * @param millis The desired value for the millisecond component of this at the completion of the call. The actual value is the result of parameter normalization.
	 * @param nanos The desired value for the nanosecond component of this at the completion of the call. The actual value is the result of parameter normalization. 
	 */
	@BlockFree
	@SCJAllowed
	 ...
	 * @return true  if the parameter object is of the same type and has the same values as this.
	 */
	@BlockFree
	@SCJAllowed
