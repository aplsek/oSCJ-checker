...
public class SCJRestrictedChecker extends SinglePassChecker {
	...
	public Properties getMessages() {
        ...
        p.put(ERR_ILLEGAL_METHOD_CALL,
                "@SCJRestricted : Illegal invocation of a method annotated %s from within a method annotated %s");
        p.put(ERR_ILLEGAL_OVERRIDE, "May not override %s with %s");
        p.put(ERR_ILLEGAL_NO_OVERRIDE,
                "@SCJRestricted Illegal Override: The inherited/overridden annotations must be restated. The overriding method is missing the @SCJRestricted annotation while the overriden method has one.");
